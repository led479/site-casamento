<template>
  <section
    class="relative min-h-[100vh] flex flex-col items-center justify-center w-full px-8 py-14 text-p2-dark-gray-brown bg-cover" :style="{ backgroundImage: `url(${Pg2Fundo})` }"
  >
